...
<!-- <link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.0.0-alpha/css/bootstrap.css" rel="stylesheet"> -->
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center sm:items-center py-4 sm:pt-0 mt-8">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 underline">Bob's Feedback</a>
                    @else
                        <a href="{{ route('addreview') }}" class="text-sm text-gray-700 underline">Leave a review for Bob</a>
